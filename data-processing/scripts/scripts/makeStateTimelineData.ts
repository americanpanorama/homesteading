...
[...Array(50).keys()].map(d => d + 1863).forEach(year => {
  ...
  townshipsData.forEach((d: ProjectedTownship) => {
    ...
    const yearData: TimelineYearPlaceData = {
      ...
      acres_claimed_indian_lands: d.acres_claimed_indian_lands,
      acres_patented: d.acres_patented,
      claims: d.claims,
      claims_indian_lands: d.claims_indian_lands,
      patents: d.patents,
      commutations_2301: d.commutations_2301,
      acres_commuted_2301: d.acres_commuted_2301,
      commutations_18800615: d.commutations_18800615,
      acres_commuted_18800615: d.acres_commuted_18800615,
      commutations_indian_lands: d.commutations_indian_lands,
      acres_commuted_indian_lands: d.acres_commuted_indian_lands,
      patents_indian_lands: d.patents_indian_lands,
      acres_patented_indian_lands: d.acres_patented_indian_lands,
      area: d.area,
    };
