...
const cleanedData: CleanedData[] = (newData as Data[]).map(nd => {
  ...
  return {
    ...
    acres_claimed_indian_lands: typeof nd.claims_ac_indian_lands === 'number' ? nd.claims_ac_indian_lands : 0,
    acres_patented: typeof nd.patents_ac === 'number' ? nd.patents_ac : 0,
    claims: typeof nd.claims_num === 'number' ? nd.claims_num : 0,
    claims_indian_lands: typeof nd.claims_num_indian_lands === 'number' ? nd.claims_num_indian_lands : 0,
