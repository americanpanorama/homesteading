...
const texts: { [index in Exclude<TextType, 'about'>]: React.ReactElement } = {
    sources: (
        <React.Fragment>
            <h3>
                Sources
...
export default function About() {
    ...
    const aboutContent = (
        <React.Fragment>
            ...
            <p>
                If you are citing <cite>Homesteading, 1862-1912</cite>, we recommend the following format using the <cite>Chicago Manual of Style</cite>:
            </p>

            <Styled.Citation>Julius Wilm, Robert K. Nelson, and Justin Madron, “Homesteading,” <cite>American Panorama</cite>, ed. Robert K. Nelson and Edward L. Ayers, accessed {todayString}, https://dsl.richmond.edu/panorama/homesteading/.</Styled.Citation>
