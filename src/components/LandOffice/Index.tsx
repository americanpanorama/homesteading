...
import { TimelineYearPlaceData, TimelinePlaceData, TimelineYearPlaceDataWithStats, TimelinePlaceDataWithStats, PlaceType } from '../../index.d';
import { calculateDistrictYearStats } from '../../utilities';
import LandOfficeStyles from './styled';
...
const Office = () => {
  ...
  if (timelinePlaceData && timelinePlaceData.length > 0) {
    ...
    const syd: TimelineYearPlaceDataWithStats = landOfficeData.yearData.find(yd => yd.year === yearNum);
